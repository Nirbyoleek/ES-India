    ...
    <div className={classes.Container} id="works">
      <div className={classes.Work}>
        ...
        <span className={classes.pointContainerMobC} id="DDM1">
                ...
                <BsFillXCircleFill className={classes.closeicon} style={{ fontSize: "20px",float: "right",margin:"10px",}} 
                  onClick={
                    ()=>{
                      ...
                      document.getElementById("DDM2").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM2").classList.add(classes.pointContainerMobC);
                      document.getElementById("DDM3").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM3").classList.add(classes.pointContainerMobC);
                      document.getElementById("DDM4").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM4").classList.add(classes.pointContainerMobC);
                      document.getElementById("DDM5").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM5").classList.add(classes.pointContainerMobC);
                      document.getElementById("DDM6").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM6").classList.add(classes.pointContainerMobC);
                    }
                  }
                ></BsFillXCircleFill>
                <br/>
          ...
          <Fade direction={"right"} triggerOnce={true}>
            ...
            <div>
              ...
              <p 
                ...
                onClick={()=>
                  {
                    document.getElementById("DDM1").classList.remove(classes.pointContainerMobC);
                    document.getElementById("DDM1").classList.add(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.add(classes.pointContainerMobC);
                    document.getElementById("DDM3").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM3").classList.add(classes.pointContainerMobC);
          ...
          <Fade direction={"right"} triggerOnce={true}>
            <div>
              ...
              <p 
                ...
                onClick={()=>
                  {
                    document.getElementById("DDM2").classList.remove(classes.pointContainerMobC);
                      document.getElementById("DDM2").classList.add(classes.pointContainerMobO);
                      document.getElementById("DDM1").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM1").classList.add(classes.pointContainerMobC);
                      document.getElementById("DDM3").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM3").classList.add(classes.pointContainerMobC);
          ...
          <Fade direction={"right"} triggerOnce={true}>
            <div>
              ...
              <p 
                ...
                onClick={()=>
                  {
                      document.getElementById("DDM3").classList.remove(classes.pointContainerMobC);
                      document.getElementById("DDM3").classList.add(classes.pointContainerMobO);
                      document.getElementById("DDM2").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM2").classList.add(classes.pointContainerMobC);
                      document.getElementById("DDM1").classList.remove(classes.pointContainerMobO);
                      document.getElementById("DDM1").classList.add(classes.pointContainerMobC);
          ...
          <Fade direction={"right"} triggerOnce={true}>
            <div>
              ...
              <p 
                ...
                onClick={()=>
                  {
                    document.getElementById("DDM4").classList.remove(classes.pointContainerMobC);
                    document.getElementById("DDM4").classList.add(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.add(classes.pointContainerMobC);
                    document.getElementById("DDM3").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM3").classList.add(classes.pointContainerMobC);
          ...
          <Fade direction={"right"} triggerOnce={true}>
            <div>
              ...
              <p 
                ...
                onClick={()=>
                  {                  
                    document.getElementById("DDM5").classList.remove(classes.pointContainerMobC);
                    document.getElementById("DDM5").classList.add(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.add(classes.pointContainerMobC);
                    document.getElementById("DDM3").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM3").classList.add(classes.pointContainerMobC);
          ...
          <Fade direction={"right"} triggerOnce={true}>
            <div>
              ...
              <p 
                ...
                onClick={()=>
                  {
                    document.getElementById("DDM6").classList.remove(classes.pointContainerMobC);
                    document.getElementById("DDM6").classList.add(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM2").classList.add(classes.pointContainerMobC);
                    document.getElementById("DDM3").classList.remove(classes.pointContainerMobO);
                    document.getElementById("DDM3").classList.add(classes.pointContainerMobC);
